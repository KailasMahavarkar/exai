 ...
 */
export function shouldPreExcludeDir(
  dirName: string,
  extra?: string[],
 ...
 */
export function shouldPreExcludeFileName(
  fileName: string,
  allowTestFiles: boolean = false
): boolean {
  const lower = fileName.toLowerCase();
 ...
 */
export function matchesAiExclusion(relativePath: string, aiExcludePatterns: string[]): boolean {
