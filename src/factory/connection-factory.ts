...
function mapEdgeStyle(style?: EdgeStyle): Partial<ExcalidrawArrow> {
    ...
    const result: Partial<ExcalidrawArrow> = {
        ...
        // Use !== undefined (not ??) so that null ("no arrowhead") is preserved
        endArrowhead: style.endArrowhead !== undefined ? style.endArrowhead : 'arrow',
        elbowed: style.elbowed,
    };
...
export function createArrow(
    ...
    return {
        ...
        elbowed: styleProps.elbowed ?? false,
    } as ExcalidrawArrow;
}
